...
We also tested the similarity of presence/absence profiles between pangenomes constructed with different methods using the Mantel test. <!-- Maybe add a citation for Mantel test? I had to look it up --> 
...
<!-- How was the content of core genomes assessed? -->
...
<!-- Which figure should I be looking at for the 83.9% and 73.5% values? -->
...
<!-- Is it possible to compute distance by mya from GTDB-tk? -->
...
<!-- Is there a figure for noncoding reads in pseudogenes? -->
...
<!-- Is there a figure for read error rates in coding vs noncoding? -->
