...
To select representative species, we first filtered species with fewer than 20 genomes and greater than 1000 genomes.
...
Orpheum perform six-frame translation on nucleotide sequencing reads, calculates k-mers in an amino acid encoding at the designated k-mer length, and then estimates the Jaccard similarity between k-mers in each translation frame and a database. 
...
We decontaminated each bin using charcoal using default parameters [@url:https://github.com/dib-lab/charcoal].
