...
On average, 5.3% (SD = 2.8%) of reads that were coding were predicted to be non-coding, while 4.9% (SD = 1.5%) of reads that were non-coding were predicted to be coding.
